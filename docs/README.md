...
The [architecture baseline](ARCHITECTURE.md) records the selected application boundaries, workspace shape, persistence, deployment, identity, and MCP connection model.
